...
var banner = ['/**',
              ' * Alien v<%= pkg.version %> - <%= pkg.description %>',
              ' * @link <%= pkg.homepage %>',
...
var pluginsCSS = ['assets/vendor/bootstrap/css/bootstrap.min.css',
                  ...
                  'assets/vendor/alien-icon/css/style.css',
...
gulp.task('sass', function(){
    return gulp.src('assets/build/sass/'+pkg.name+'.sass')
        .pipe(sass())
        .pipe(plumber())
        .pipe(autoprefixer({
...
gulp.task('inject', function(){
    ...
    var appStream = gulp.src(['assets/css/'+pkg.name+'.min.css', 'assets/js/'+pkg.name+'.js'], {read: false});
    gulp.src('*.html')
...
gulp.task('injectPro', function(){
    var source = gulp.src(['assets/css/plugins.css', 'assets/css/'+pkg.name+'.min.css', 'assets/js/plugins.js', 'assets/js/'+pkg.name+'.min.js'], {read: false});
    gulp.src('*.html')
